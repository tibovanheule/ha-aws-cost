...
class AWSCostSensorEntity(CoordinatorEntity[AWSCostDataUpdateCoordinator], SensorEntity):
    """Defines an AWS Cost sensor."""

    entity_description: AWSCostSensorEntityDescription
    _attr_has_entity_name = True

    def __init__(self, *, entry_id: str, coordinator: AWSCostDataUpdateCoordinator, entity_description: AWSCostSensorEntityDescription) -> None:
